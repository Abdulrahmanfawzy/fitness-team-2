...
import { testimonials } from "@/components/lib/constants/Trainer/TrainerData";
  ...
  return (
    <div className="mb-12 p-5">
      ...
      <div className="flex flex-col md:flex-row gap-6 max-w-5xl mx-auto">
        {/* Left Panel */}
        <div className="md:w-52 shrink-0 bg-card border border-border rounded-xl p-6 flex flex-col justify-between min-h-[180px]">
          <div>
