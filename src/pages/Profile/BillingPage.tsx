  ...
  return (
    <div className="px-4 md:px-8 mt-6 md:mt-10 ">
     ...
     <div className="border border-[#A7A7A7] rounded-xl p-8 mb-5 grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div className="border-b border-[#A7A7A7] rounded-xl px-4">
        <div className="font-semibold text-lg grid grid-cols-2 md:grid-cols-5 m-3 text-center">
          <p>Invoice</p>
          <p>Date</p>
          <p>Description</p>
          <p>Amount</p>
        ...
        {invoices.map((inv, i) => (
          <div
            ...
            <p>{inv.desc}</p>
            <p>{inv.amount}</p>
            <span className="bg-[#22C55E1A] text-[#22C55E] text-xs rounded-lg py-1 px-3 w-40 mx-auto">
              {inv.status}
            </span>
          </div>
        ))}
