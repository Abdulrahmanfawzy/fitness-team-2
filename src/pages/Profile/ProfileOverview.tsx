  ...
  return (
    <div className="text-white px-4 md:px-8">
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-6">
        <img
          src={profileImage || data?.uploadimage}
        ...
        <div className="flex flex-col items-start gap-2">
          <div className="flex gap-3">
            <button
              ...
              className="bg-[#FF4D4D] px-9 py-2.5 rounded-md tracking-tight text-xs font-bold hover:bg-black border border-[#FF4D4D] transition"
            >
              Upload New
            </button>
            <button
