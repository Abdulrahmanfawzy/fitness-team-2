...
const FilterPanel = ({ onClose }: FilterPanelProps) => {
  return (
    <div className="w-full lg:w-4xl min-h-[600px] bg-[#111111] absolute top-full mt-4 right-0 z-50 rounded-xl border border-[#3A3A3C] shadow-2xl">
      {/* header */}
        ...
        <div className="border border-[#3A3A3C] rounded-lg overflow-hidden flex flex-col">
          <div className="flex justify-between items-center bg-[#FE4E4E] text-white px-4 py-3 cursor-pointer">
            ...
            <span className="flex items-center gap-1 text-[15px]">
              Any <IoCheckmark className="text-xl" />
            </span>
          </div>
          <div className="text-gray-200 px-4 py-3 border-t border-[#3A3A3C] cursor-pointer hover:bg-white/5 transition text-[15px]">
            10-20 min
          </div>
          <div className="text-gray-200 px-4 py-3 border-t border-[#3A3A3C] cursor-pointer hover:bg-white/5 transition text-[15px]">
            20-30 min
      ...
      <div className="px-6 py-6">
        ...
        <div className="flex gap-2 mb-10 pb-2 flex-wrap">
          <button className=" border border-[#3A3A3C] text-gray-200 px-6 py-2 text-[15px] hover:bg-white/5 transition">
            HIIT
          </button>
          <button className="border border-[#3A3A3C] text-gray-200 px-6 py-2 text-[15px] hover:bg-white/5 transition">
            Strength
